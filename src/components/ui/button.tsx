  ...
  "inline-flex min-h-11 items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-semibold cursor-pointer transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50 disabled:cursor-not-allowed [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        gold: "bg-gold text-gold-foreground shadow-sm hover:bg-gold/90 hover:-translate-y-0.5",
        hero: "border border-hero-foreground/30 bg-hero-foreground text-hero hover:bg-hero-foreground/90 hover:-translate-y-0.5",
        heroOutline: "border border-hero-foreground/50 bg-transparent text-hero-foreground hover:bg-hero-foreground/10",
      },
      size: {
